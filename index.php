...
<head>
    ...
    <style>
      ...
      .btn-primary {
        ...
        /* Footer */
        footer {
            background: linear-gradient(135deg, var(--white) 0%, var(--deep-blue) 100%);
            color: var(--navy);
            text-align: center;
            padding: 3rem 2rem;
            margin-top: 5rem;
...
<body>
    ...
    <section class="hero">
        <div class="container hero-content">
            <h1 class="fade-in">Welcome to ToyVerse</h1>
            <p class="hero-subtitle fade-in">Collect the cutest designer figurines.</p>
            <div class="text-center mt-4">
                <a href="login.php" class="btn-obsidian btn-primary" style="border-radius: 8px;">Login</a>
                <a href="register.php" class="btn-obsidian btn-primary" style="border-radius: 8px;">Sign up</a>
            </div>
        </div>
    </section>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 style="color: var(--electric-purple); margin-bottom: 1rem; font-weight: 700;">ToyVerse's Hirana</h4>
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        ...
                        <p>contact: <a href="mailto:info@popmarthirono.com">info@toyversehirana.com</a> | <a href="tel:+18005551234">+1 800 555 1234</a></p>
                    </div>
                    <div>
    ...
    <script>
        ...
        const carousel = document.querySelector('#obsidianCarousel');
